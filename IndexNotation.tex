...
\definecolor{mydarkcolor}{RGB}{128, 0, 32}
\hypersetup{
  colorlinks=true,
  linkcolor=mycolor,
  urlcolor=mycolor,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Title, author, date
\title{Formalization of index notation in Lean 4}
...
\proofstep{\lstinline!rw [contr_tensor_eq <| contr_tensor_eq <| prod_tensor_eq_fst <| hA]!}{
  ...
  \begin{tikzpicture}
    ...
    \node[draw=black] (B) at (0,-1) {contr 0 1};
    \node[draw=black] (C) at (0,-2) {prod};
    \node[draw=mydarkcolor] (D1) at (-1,-3) {perm \_};
    \node[draw=mydarkcolor] (E1) at (-1,-4) {neg};
    \node[draw=mydarkcolor] (F1) at (-1,-5) {A};
    \node[draw=black] (D2) at (1,-3) {S};
    \path [->] (A) edge (B);
    \path [->] (B) edge (C);
    \path [->] (C) edge (D1);
    \path [->, color = mydarkcolor] (D1) edge (E1);
    \path [->, color = mydarkcolor] (E1) edge (F1);
    \path [->] (C) edge (D2);
  \end{tikzpicture}
}
...
\proofstep{\lstinline!rw [contr_tensor_eq <| contr_tensor_eq <| prod_tensor_eq_snd <| hs]!}{
  ...
  \begin{tikzpicture}
    ...
    \node[draw=mydarkcolor] (D2) at (1,-3) {perm \_};
    \node[draw=mydarkcolor] (F2) at (1,-4) {S};
    \path [->] (A) edge (B);
    \path [->] (B) edge (C);
    \path [->] (C) edge (D1);
    \path [->] (D1) edge (E1);
    \path [->] (E1) edge (F1);
    \path [->] (C) edge (D2);
    \path [->, color=mydarkcolor] (D2) edge (F2);
  \end{tikzpicture}
}
...
\proofstep{\lstinline!rw [contr_tensor_eq <| contr_tensor_eq <| prod_perm_left _ _ _ _]!}{
  ...
  \begin{tikzpicture}
    \node[draw=black] (A) at (0,0) {contr 0 0};
    \node[draw=black] (B) at (0,-1) {contr 0 1};
    \node[draw=mydarkcolor] (C) at (0,-2) {perm \_};
    \node[draw=mydarkcolor] (D) at (0,-3) {prod};
    \node[draw=black] (E1) at (-1,-4) {neg};
    \node[draw=black] (F1) at (-1,-5) {A};
    ...
    \path [->] (A) edge (B);
    \path [->] (B) edge (C);
    \path [->, color = mydarkcolor] (C) edge (D);
    \path [->, color = mydarkcolor] (D) edge (E1);
    \path [->] (E1) edge (F1);
    \path [->] (D) edge (E2);
    \path [->] (E2) edge (F2);
  \end{tikzpicture}
...
\proofstep{\lstinline!rw [contr_tensor_eq <| contr_tensor_eq <| perm_tensor_eq <| prod_perm_right _ _ _ _]!}{
  ...
  \begin{tikzpicture}
    ...
    \node[draw=mydarkcolor] (D) at (0,-3) {perm \_};
    \node[draw=mydarkcolor] (E) at (0,-4) {prod};
    ...
    \path [->] (B) edge (C);
    \path [->] (C) edge (D);
    \path [->, color = mydarkcolor] (D) edge (E);
    \path [->] (E) edge (F1);
    \path [->, color = mydarkcolor] (E) edge (F2);
    \path [->] (F1) edge (G1);
  \end{tikzpicture}
}
...
\proofstep{\lstinline!rw [contr_tensor_eq <| perm_contr_congr 1 2]!}{
  ...
  \begin{tikzpicture}
    \node[draw=black] (A) at (0,0) {contr 0 0};
    \node[draw=mydarkcolor] (B) at (0,-1) {perm \_};
    \node[draw=mydarkcolor] (C) at (0,-2) {contr 1 2};
    \node[draw=black] (D) at (0,-3) {prod};
    \node[draw=black] (E1) at (-1,-4) {neg};
    \node[draw=black] (F1) at (-1,-5) {A};
    \node[draw=black] (E2) at (1,-4) {S};
    \path [->] (A) edge (B);
    \path [->, color = mydarkcolor] (B) edge (C);
    \path [->, color = mydarkcolor] (C) edge (D);
    \path [->] (D) edge (E1);
    \path [->] (D) edge (E2);
    \path [->] (E1) edge (F1);
...
\proofstep{\lstinline!rw [perm_contr_congr 0 0]!}{
  ...
  \begin{tikzpicture}
    \node[draw=mydarkcolor] (A) at (0,0) {perm \_};
    \node[draw=mydarkcolor] (B) at (0,-1) {contr 0 0};
    \node[draw=black] (C) at (0,-2) {contr 1 2};
    \node[draw=black] (D) at (0,-3) {prod};
    \node[draw=black] (E1) at (-1,-4) {neg};
    \node[draw=black] (F1) at (-1,-5) {A};
    \node[draw=black] (E2) at (1,-4) {S};
    \path [->, color = mydarkcolor] (A) edge (B);
    \path [->, color = mydarkcolor] (B) edge (C);
    \path [->] (C) edge (D);
    \path [->] (D) edge (E1);
    \path [->] (D) edge (E2);
...
\proofstep{\lstinline!rw [perm_tensor_eq <| contr_contr _ _ _]!}{
  ...
  \begin{tikzpicture}
    ...
    \node[draw=mydarkcolor] (A') at (0,-1) {perm \_};
    \node[draw=mydarkcolor] (B) at (0,-2) {contr 0 0};
    \node[draw=mydarkcolor] (C) at (0,-3) {contr 0 1};
...
\proofstep{\lstinline!rw [perm_tensor_eq <| contr_tensor_eq <| contr_tensor_eq <| neg_fst_prod _ _]!}{
  ...
  \begin{tikzpicture}
    ...
    \node[draw=black] (B) at (0,-1) {contr 0 0};
    \node[draw=black] (C) at (0,-2) {contr 0 1};
    \node[draw=mydarkcolor] (D) at (0,-3) {neg};
    \node[draw=mydarkcolor] (E) at (0,-4) {prod};
    \node[draw=black] (F1) at (-1,-5) {A};
    \node[draw=black] (F2) at (1,-5) {S};
    \path [->] (A) edge (B);
    ...
    \path [->] (C) edge (D);
    \path [->, color = mydarkcolor] (D) edge (E);
    \path [->, color = mydarkcolor] (E) edge (F1);
    \path [->] (E) edge (F2);
  \end{tikzpicture}
}
...
\proofstep{\lstinline!rw [perm_tensor_eq <| contr_tensor_eq <| neg_contr _]!}{
  ...
  \begin{tikzpicture}
    \node[draw=black] (A) at (0,0) {perm \_};
    \node[draw=black] (B) at (0,-1) {contr 0 0};
    \node[draw=mydarkcolor] (C) at (0,-2) {neg};
    \node[draw=mydarkcolor] (D) at (0,-3) {contr 0 1};
...
\proofstep{\lstinline!rw [perm_tensor_eq <| neg_contr _]!}{
  ...
  \begin{tikzpicture}
    \node[draw=black] (A) at (0,0) {perm \_};
    \node[draw=mydarkcolor] (B) at (0,-1) {neg};
    \node[draw=mydarkcolor] (C) at (0,-2) {contr 0 0};
...
Inspired by Lean
blueprints~\cite{leanblueprint}, we have added to HepLean informal lemmas related to index notation and tensors. 
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{informalLemmas.png}
  \caption{Part of the informal dependency graph in HepLean. Gray nodes indicate informal results, whilst 
...
I thank Sven Krippendorf, Andreas Schachner, and Tarmo Uustalu for helpful discussions related to this project.
I also thank Jan Idziak,  Thomas Murrills, and Tomas Skrivan for 
